...
typedef struct {
    ...
    ZARRType_4 buffers[160][128][128][128];
    int bufferIndex[160][3];
    unsigned char written[160];
    uint64_t bufferUsed[160];
...
{	
	...
	for(z->index = 0; z->index < 160; z->index++)
	{
